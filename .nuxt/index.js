...
import nuxt_plugin_plugin_c3bdfab0 from 'nuxt_plugin_plugin_c3bdfab0' // Source: ./components/plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Константин Вороной","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"My super-excellent Nuxt.js project"}],"link":[],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_c3bdfab0 === 'function') {
    await nuxt_plugin_plugin_c3bdfab0(app.context, inject)
  }
